package ru.dmitriy.commondomain.listener;
...
public class UserValidationResponseEventListener {
    private static final Logger log = LoggerFactory.getLogger(UserValidationResponseEventListener.class);
    ...
    public void checkUserId(Long userId) throws ServiceUnavailableException, UserNotFoundException {
        boolean userExists = validateUser(userId);
        if (!userExists) {
